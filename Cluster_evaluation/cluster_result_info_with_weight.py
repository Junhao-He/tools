...
if __name__=='__main__':
    ...
    # data_count = '34w'
    formula = 1
    # timestamp = ["2018-06-01T11:19:29.000Z", "2018-06-04T11:19:29.000Z"]
    timestamp = ["2018-06-09 12:00:00", "2018-06-10 12:00:00"]
    thr = [0.656, 0.613, 0.57, 0.53, 0.52, 0.48]
    # thr = [0.656]
    # index_name1 = "fused_src_data_nightowl_ycys_"+data_count+"_"+str(th)
    # index_name1 = "fused_src_data_nightowl_ycys_92"
    # index_name2 = "history_fss_data_v1_1_ycys_data"
    index_name1 = "fused_src_data_nightowl_0415_kmeans"
    index_name2 = "fss_history_yc_without_nullfeature"

    result = get_data_from_ES(index_name1, 'fused')
    fea_result, data_count = get_data_from_ES(index_name2, 'history_data', timestamp)
    # print(data_count)
