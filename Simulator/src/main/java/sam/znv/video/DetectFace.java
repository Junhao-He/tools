...
public class DetectFace {
    private static final String url = "http://10.45.154.64:9010/verify/face/detect";
    public static void main(String[] args) {
        System.load(System.getProperty("user.dir") + "\\opencv_java340-x64.dll");
        detectPictureFace("D:\\img", "D:\\doc44");
    }

    public static void detectPictureFace(String pictureDocumentPath, String targetPath){
        ...
        if(picDoc.isDirectory()){
            ...
            for (File file2 : files) {
                parseOnePictureData(file2.toString(), targetPath);
            }
        }else{
            parseOnePictureData(pictureDocumentPath, targetPath);
        }
    }


    public static void parseOnePictureData(String picturePath, String targetPath){
        JSONObject urlResult = JSON.parseObject(getImageFeature(picturePath, url));
        ...
        if(result.size() != 0){
            ...
            System.out.println("未识别人脸图片： %s"+picturePath);
        }
    }
