...
public class FeatureFieldMapper extends FieldMapper {
    ...
    private  ImmutableOpenMap<String, FieldMapper> featureMappers = ImmutableOpenMap.of();
    private  List<String> hashes;
    private  ImmutableOpenMap<String, FieldMapper> hashMappers = ImmutableOpenMap.of();
    private  ImmutableOpenMap<String, FieldMapper> lopqMappers = ImmutableOpenMap.of();
